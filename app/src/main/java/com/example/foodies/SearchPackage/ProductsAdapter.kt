package com.example.foodies.SearchPackage
...
class ProductsAdapter(cdm: CartDataManager, cM: CategoriesManager) : RecyclerView.Adapter<ProductsAdapter.ProductsViewHolder>() {
    private var list = emptyList<Products>()
    var carDatatManager: CartDataManager
    ...
    override fun onBindViewHolder(holder: ProductsViewHolder, position: Int) {
        ...
        holder.itemView.buy.setOnClickListener{
            carDatatManager.append(holder.itemView.name_product.text.toString())
        ...
        holder.itemView.counter.minus.setOnClickListener{
            ...
            carDatatManager.pop(holder.itemView.name_product.text.toString())
            if(count == 1){
                holder.itemView.buy.visibility = View.VISIBLE
                holder.itemView.buy.isClickable = true
                holder.itemView.counter.visibility = View.INVISIBLE
